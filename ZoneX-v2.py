...
while laueft:
    ...
    for g in gegner:
        if (g[0], g[1]) == (g[4], g[5]):  # Wenn der Gegner einen Rasterpunkt erreicht hat
            ...
            versuche = 0
            while versuche < 4:  # Maximal 4 Versuche, da es nur 4 Richtungen gibt
                if versuche == 0:
                    neue_richtung = g[2]  # Zuerst die aktuelle Richtung beibehalten
                else:
            ...
            if versuche == 4:  # Wenn kein freier Weg gefunden wurde, pausiere
                g[4], g[5] = g[0], g[1]
